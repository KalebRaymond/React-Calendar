# React Calendar
A Google Calendars style calendar made with React, Redux, and JSON-Server. Lets you add, modify, and delete events on the calendar. https://kalebraymond.github.io/React-Calendar/ (*Note: event functionality does not work since it is handled server-side using json-server middleware)
